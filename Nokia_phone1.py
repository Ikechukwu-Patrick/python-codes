...
def main_menu():
    ...
    else: print(main_menu_wrong_input())

def main_menu_wrong_input():
	going_back_wrong = (input(" wrong input press 1 or go back to main menu :"))
	if going_back_wrong == '1' : print(nokia_phone())
	else: print(main_menu_wrong_input())
...
def square_number():
    ...
    square_number = number1 * number1
    print(f'The square of {number1} is = {square_number}')


def square_root():
    number2 = int(input("Enter Number: "))
    square_root = number2 ** 0.5
    print(f'The square root of  {number2} is = {square_root}')

def modulo_number():
    number1 = int(input('Enter number  '))
    number2 = int(input('Enter second number  '))
    modulo_number = number1 % number2
    print(f'the modulo of {number1} is = {modulo_number}')
...
def calculator():
   ...
   6-> modulo_number
   7-> others
   select option 1 to 6 to do matthematical operations:   """)
    ...
    match calculator_menu:
        ...
        case '4':
            print(square_number()), print(main_menu())
        case '5':
            print(square_root()), print(main_menu())
        case '6':
	    	print(modulo_number()), print(main_menu())
	#case '7':
